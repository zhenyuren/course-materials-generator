...
# 添加课程组负责人签字行（第20行）- 在表右边部分，有黑线边框
leader_cell = ws.cell(row=20, column=9, value='课程组负责人签字：')
...
# 添加日期行（第21行）- 在表右边部分，有黑线边框
date_cell = ws.cell(row=21, column=9, value='日期：')
...
# 合并课程组负责人签字行和日期行（在表右边部分）
ws.merge_cells('I20:N20')
ws.merge_cells('I21:N21')
...
print('✅ 完全一致模板V2已创建: 期初资料/附件3 课程组教学资料检查情况记录表-完全一致模板.xlsx')