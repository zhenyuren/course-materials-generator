...
# 设置表头（第2行）- 先不合并，设置完值后再合并
headers = ['序号', '课程代码', '课程名', '开课单位', '使用年级/层次/专业', '归属校区', '教师（执笔人）', '课程组验收负责人']
...
# 保存文件
wb.save('期初资料/附件3 课程组教学资料检查情况记录表-精确模板.xlsx')
print('✅ 精确模板文件已创建: 期初资料/附件3 课程组教学资料检查情况记录表-精确模板.xlsx')