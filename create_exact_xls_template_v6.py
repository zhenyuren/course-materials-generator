...
h19_cell.alignment = Alignment(horizontal='center', vertical='top', wrap_text=True)
h19_cell.border = thin_border

# 添加课程组负责人签字行（第20行）- 在表右边部分，无边框，靠最右（N列）
leader_cell = ws.cell(row=20, column=14, value='课程组负责人签字：')
...
date_cell = ws.cell(row=21, column=12, value='日期：')
...
print('✅ 完全一致模板V6已创建: 期初资料/附件3 课程组教学资料检查情况记录表-完全一致模板.xlsx')