...
h19_cell.fill = light_gray_fill

# 添加课程组负责人签字行（第20行）- 在表右边部分，无边框
...
# 添加日期行（第21行）- 在表右边部分，无边框
date_cell = ws.cell(row=21, column=7, value='日期：')
...
print('✅ 完全一致模板V4已创建: 期初资料/附件3 课程组教学资料检查情况记录表-完全一致模板.xlsx')